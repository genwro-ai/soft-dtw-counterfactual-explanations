"""
Soft Dynamic Time Warping (Soft-DTW) implementation for time series alignment.
code taken from: https://github.com/Sleepwalking/pytorch-softdtw
"""
...
class SoftDTW(torch.nn.Module):
    ...
    def calc_distance_matrix(self, x, y):
        # Memory-efficient version using the identity: (a - b)^2 = a^2 + b^2 - 2ab
        # The previous implementation was memory-intensive for long time series.
