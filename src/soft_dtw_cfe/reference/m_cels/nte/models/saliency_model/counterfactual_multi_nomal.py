...
class CFExplainer(Saliency):
    ...
    def generate_saliency(self, data, label, **kwargs):
        ...
        # print(perturbated_input.shape)
        
        save_timeseries_mul(mask=converted_mask, raw_mask=None,
        ...
        # print(type(perturbated_input))
        perturbated_input = perturbated_input.cpu().detach().numpy()
